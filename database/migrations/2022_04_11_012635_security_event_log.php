...
return new class extends Migration
{
     ...
     */
     public function up()
     {
         Schema::create('security_event_log', function (Blueprint $table) {
             $table->string("id")->default(DB::raw('(UUID())'));
             $table->string("device_id")->nullable(); //ID of device that generated the event (if any)
             $table->string("type")->nullable(false); //The log message type. This is required.
     ...
     {
         Schema::dropIfExists('security_event_log');
     }
};
